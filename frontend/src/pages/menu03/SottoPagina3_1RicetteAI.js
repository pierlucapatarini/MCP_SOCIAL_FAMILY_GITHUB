...
function FunRecipeAI() {
    ...
    /**
     * Funzione per l'estrazione degli ingredienti. 
     */
...
const response = await fetch(`${API_URL}/api/recipe/extract-ingredients`, {
    ...
    /**
     * Funzione per la generazione di istruzioni, meteo e barzelletta.
     */
    ...
    return (
        <div className="recipe-ai-container">
            <header className="recipe-ai-header">
            ...
            <main className="recipe-ai-main-content">
                ...
                {recipeIngredients.length > 0 && (
                    <div className="recipe-content-card ingredient-card">
                ...
                {recipeInstructions && (
                    <div className="recipe-content-card instruction-card">
                                    ...
                                    <div key={product.id} className="modal-list-item">
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                // Opzionale: Rimuovi il prodotto dalla lista di selezione dopo l'aggiunta
                                                setProductsToSelect(prev => prev.filter(p => p.id !== product.id));
                                            }}
                                            className="btn-primary"
                                        >
                                            ➕ Aggiungi
