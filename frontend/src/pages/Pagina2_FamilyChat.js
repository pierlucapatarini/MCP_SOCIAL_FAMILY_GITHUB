...
function FamilyChat() {
    ...
    // 🛑 setupPushNotifications È STATA RIMOSSA
    ...
    useEffect(() => {
        ...
        const initChatAndPresence = async () => {
            ...
            try {
                ...
                // 🛑 RIMOSSA CHIAMATA A setupPushNotifications
                ...
                // Da: .select('*, profiles:sender_id(username)')
                // A: .select('*, profiles(username)')
    ...
    }, [navigate]); // Aggiunto 'navigate' per evitare warning, anche se stabile
    ...
    // const isSystemMessage = (messageSenderId) => messageSenderId === 'SYSTEM'; // Non usata, ma potresti volerla tenere
